...
async def handle_message(update: Update, context: ContexTypes.DEFAULT_TYPE): 
	"""Reagit a tout les messages envoye par l'utilisateur"""
...
def main():
	"""Fonction principale qui demarre le bot"""
